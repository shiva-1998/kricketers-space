        ...
        <div class="row h-100">
            ...
            <div class="col-lg-6 d-flex align-items-center justify-content-center right-panel p-5">
                <div class="form-container w-100" style="max-width: 450px;">
                    ...
                    <a href="{{ route('signup') }}"
                        class="text-secondary text-decoration-none small mb-4 d-inline-block">
                    ...
                    <form action="{{ route('user-otp.verify') }}" method="post" id="otpForm" class="mt-5">
                        @csrf
                        ...
                        <div class="text-center mt-4">
                            <p class="text-secondary small">
                                ...
                                <a href="#" class="text-info text-decoration-none fw-bold">Resend OTP</a>
                            </p>
                        </div>
                    </form>
                </div>

        ...
        <div class="row h-100">
            ...
            <div class="col-lg-6 d-flex align-items-center justify-content-center right-panel p-5">
                ...
                <a href="#" class="text-secondary text-decoration-none small mb-4 d-inline-block">
                    ...
                    <h2 class="reg_from_heading">OTP Verification</h2>
                    <p class="reg_from_subheading">Enter the code to continue</p>

               
                    
                    <form id="otpForm" class="mt-5">
                    <div class="d-flex gap-3 mb-3 justify-content-between">
                        <div class="otp-box-wrap">
                            <input type="text" class="form-control otp-input" maxlength="1" placeholder="6" autofocus>
                        </div>
                        <div class="otp-box-wrap">
                    ...
                    <div class="text-center mt-4">
                        <p class="text-secondary small">Didn't receive the code? <a href="#" class="text-info text-decoration-none fw-bold">Resend OTP</a></p>
                    </div>
                </form>
                </div>
            </div>

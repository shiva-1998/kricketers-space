...
<head>
 ...
 <link rel="stylesheet" href="{{ asset('assets/frontend/css/home-page-styles.css') }}">

    <link rel="stylesheet" href="{{ asset('assets/frontend/css/registration-pages-styles.css') }}">
